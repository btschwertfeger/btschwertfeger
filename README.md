...
| Project                                                                                                                                   | Description                                                                                                                                                                                                                                                                                                                                                                                      |
| :---------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| corvee <br> [![pypi](https://img.shields.io/badge/pypi-corvee-blue)](https://pypi.org/project/corvee/) | Corvee is a CLI tool and MCP server for AI agents to manage tasks and facts more efficiently.<br> [`[Github]`](https://github.com/btschwertfeger/corvee) [`[PyPI]`](https://pypi.org/project/corvee/) [`[Documentation]`](https://corvee.readthedocs.io/en/stable/)                                                                                                                                        |
